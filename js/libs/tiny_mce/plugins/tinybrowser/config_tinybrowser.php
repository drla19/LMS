...
switch ($_SERVER['HTTP_HOST']) {
    ...
    case "lms.gingersapp.sk":
        $tinybrowser['docroot'] = rtrim('/data/web/gingersapp.sk/sub/lms','/');
    break;
}
...
$tinybrowser['path']['image'] = '/media/images/'; // /useruploads/images/ Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/media/media/'; // /useruploads/media/ Media files location
$tinybrowser['path']['file']  = '/media/files/'; // /useruploads/files/ Other files location
...
$tinybrowser['filetype']['file']  = '*.txt, *.doc, *.docx, *.xls, *.xlsx, *.pdf, *.ppt, *.pptx'; // Other file types
